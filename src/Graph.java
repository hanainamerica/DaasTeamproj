...
public class Graph<E>
{
   ...
   public void depthFirstTraversalHelper(Vertex<E> startVertex, Visitor<E> visitor)
   {
       ...
       while (iter.hasNext())
       {
           ...
           if(!nextVertex.isVisited())
               depthFirstTraversalHelper(nextVertex, visitor);
       }
   }
   ...
   public void writeToFile(PrintWriter writer)
   {
       ...
       writer.println("-----------");
       for(Vertex<E> v : vertexSet.values())
           writer.println(v.data);
    
       writer.println("\n-----------------");
       writer.println("Adjacency List");
       writer.println("-----------------");
       for(Vertex<E> v : vertexSet.values()) {
           writer.print(v.data);
           writer.print(" : ");
           for(Pair<Vertex<E>, Double> adj : v.adjList.values()) {
               writer.print(adj.first.data);
               writer.print(" ");
           }
           writer.println();
       }
